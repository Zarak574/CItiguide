...
import 'package:rolebase/pages/profile/all_users.dart';
import 'package:rolebase/pages/profile/bookmark.dart';
import 'package:rolebase/pages/profile/my_profile.dart';
import 'package:rolebase/pages/profile/user_posts.dart';
...
class _AdminProfileState extends State<AdminProfile> {
  ...
  Future<String?> _getUserProfileImageUrl(String uid) async {
    try {
      ...
      if (doc.exists) {
        return doc.data()?['profile_picture'];  // Fetch the correct field for profile picture
      }
    } catch (e) {
