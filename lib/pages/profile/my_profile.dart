                  ...
                  Center(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Positioned(
                          bottom: -5,  // Adjusted to fit the smaller size
                          right: -5,   // Adjusted to fit the smaller size
                          child: InkWell(
                            onTap: _pickImage,
                            child: Container(
                              ...
                              child: const Icon(Icons.add_a_photo, size: 20, color: Colors.white),  // Reduced icon size
                            ),
                          ),
                        ),
                      ],
