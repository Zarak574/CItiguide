...
import 'package:rolebase/pages/account/posts/editpost_screen.dart';
import 'package:rolebase/pages/account/posts/upload_screen.dart';
      ...
      return FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            ...
            return AlertDialog(
              backgroundColor: Theme.of(context).colorScheme.secondary,
              content: const Text('Error fetching counts'),
              actions: [
                TextButton(
                  child: const Text(
                    'Close',
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              _userData?['bio'] ?? 'This is a user bio', 
                              style: TextStyle(
                                color: Theme.of(context).colorScheme.inversePrimary,
                                fontSize: 14,
                              ),
          ...
          Padding(
            padding: const EdgeInsets.only(left: 6, right: 10, bottom: 10, top: 5),
            child: Divider(
