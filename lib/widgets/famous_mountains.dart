...
class FamousMountains extends StatefulWidget {
  @override
  _FamousMountainsState createState() => _FamousMountainsState();
}

class _FamousMountainsState extends State<FamousMountains> {
  List<Map<String, dynamic>> FamousMountains = [];
  User? user;
  ...
  void initState() {
    ...
    fetchFamousMountains();
  }

  Future<void> fetchFamousMountains() async {
    try {
      ...
      if (snapshot.snapshot.value != null) {
        ...
        setState(() {
          FamousMountains = values.entries.map((entry) {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView.separated(
        ...
        itemCount: FamousMountains.length ,
        itemBuilder: (context, index) {
          final place = FamousMountains[index];
